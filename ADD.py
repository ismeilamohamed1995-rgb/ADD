...
st.markdown(
    ...
    /* Image personnelle collée en haut à droite */
    .moi-photo {{
        position: fixed;
        top: 0px;
        right: 0px;
...
st.markdown(
    f'<div style="position:fixed; top:30px; right:0px; z-index:9999;">'
    f'<img src="data:image/png;base64,{moi_img}" style="width:120px; border-radius:15px; box-shadow:0px 4px 10px rgba(0,0,0,0.5);" />'
    f'<div style="text-align:center; margin-top:8px;">'
    f'<span style="font-weight:bold; color:#1a4d8f; font-size:18px;">Mohamed ISSOUMEÏLA</span><br>'
    f'<span style="font-style:italic; color:#555; font-size:15px;">Économiste Statisticien et Ingénieur Démographe</span>'
    f'</div></div>',
    unsafe_allow_html=True
)
...
uploaded_file = st.file_uploader(
    "<span style='font-size:18px; color:#1a4d8f; font-weight:bold;'>Téléchargez votre fichier CSV</span>",
    type="csv",
